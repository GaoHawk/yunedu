<template>
    <div class="template">
     ...
     Bar
     <dropzon   ref="myUnique" id="vueDropzone" url="http://localhost:8081/upload/file"  acceptedFileTypes='image/*,audio/*'  v-on:vdropzone-success="showSuccess" :autoProcessQueue="auto"></dropzon>
